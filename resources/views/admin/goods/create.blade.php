...
@csrf
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="goods_name" id="goods_name" placeholder="请输入名字">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="goods_price" id="goods_price" placeholder="请输入商品价格">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="goods_score" id="goods_score" placeholder="请输入商品积分">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="goods_num" id="goods_num" placeholder="请输入商品库存">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<textarea class="form-control" name="goods_desc" placeholder="请输入商品介绍"></textarea>
		</div>
	</div>
	<div class="form-group">
...
function checkPrice(){
	...
	if(!reg.test(goods_price)){
        $('#goods_price').next().text('商品价格需为正数且小数点后有两位');
		return false;
	}else{
